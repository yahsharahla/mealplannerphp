...
zippedCus=zip(id_list, fname, lname, email, password)
...
def generateInsertAccount():
    for c in range(0,numOfCustomers-1):
        sql_file.write("insert into account(account_id, , calorie_count, first_name, last_name, customer_password) values\n")
...
for i in range(0,200):
    itm.append(ingre_s[random.randint(0, len(i_id)-1)])
...
def generateIngredients():
    for i in range(0,199):
        sql_file.write("insert into ingredients(recipie_id, quantity, price) values\n")
